...
export async function GET(req: Request) {
  ...
  // Generate briefing with configured LLM provider
  ...
  if (!briefingContent) {
    ...
    return NextResponse.json({
      ...
      content: {
        ...
        summary: "AI briefing generation is not configured. Please set either ANTHROPIC_API_KEY or OPENAI_API_KEY in your environment and redeploy.",
        highlights: [],
